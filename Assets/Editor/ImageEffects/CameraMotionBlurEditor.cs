    ...
    class CameraMotionBlurEditor : Editor
    {
        ...
        public override void OnInspectorGUI () {
            ...
            if (filterType.enumValueIndex == 0) {
                ...
                EditorGUILayout.PropertyField (rotationScale, new GUIContent(" MainCamera Rotation"));
                EditorGUILayout.PropertyField (movementScale, new GUIContent(" MainCamera Movement"));
            }
            else {
