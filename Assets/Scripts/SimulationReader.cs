...
public class SimulationReader : MonoBehaviour
{
    ...
    void Start ()
    {
        InputFilePath = Application.dataPath + "/../Data/packing_results/pack_bloodhiv_bd.molb";
        DictionaryPath = Application.dataPath + "/../Data/packing_results/pack_bloodhiv_bd.prm";
		InputFilePathFixed = Application.dataPath + "/../Data/packing_results/pack_bloodhiv_bd_fixed.molb";
    ...
    void Update ()
    {
        ...
        if (Input.GetKey(KeyCode.RightArrow) && pause) forceNextFrame = true;
        if (Input.GetKey(KeyCode.LeftArrow) && pause) forcePreviousFrame = true;
